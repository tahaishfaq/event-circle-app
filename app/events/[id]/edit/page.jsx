...
export default function EditEventForm() {
  const [eventVideo, setEventVideo] = useState(null); // For new video file
  const [videoThumbnail, setVideoThumbnail] = useState(null); // For new thumbnail file
  ...
  useEffect(() => {
    const fetchEventData = async () => {
      try {
        ...
        setLocationData(event.eventLocation);
        setExistingVideoUrl(event.eventVideo);
        setExistingThumbnailUrl(event.videoThumbnail);
              ...
              <div className="space-y-4">
                  ...
                  <div className="mt-1 flex items-center space-x-4">
                    ...
                    <label className="cursor-pointer">
                      <span className="inline-flex items-center px-3 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                        ...
                        {eventVideo || existingVideoUrl ? "Change Video" : "Upload Video"}
                      </span>
                      <input
                        type="file"
                        className="hidden"
                    ...
                    {(eventVideo || existingVideoUrl) && (
                      <span className="text-sm text-gray-600">
                        {eventVideo?.name || "Existing video"}
                      </span>
                    )}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-1 flex items-center space-x-4">
                    ...
                    {(videoThumbnail || existingThumbnailUrl) && (
                      <span className="text-sm text-gray-600">
                        {videoThumbnail?.name || "Existing thumbnail"}
                      </span>
                    )}
                  </div>
                </div>
